  ...
  <div className="grid grid-cols-2 gap-3">
    {socialLinks.map((social, index) => (
      <a
        ...
        className="group flex items-center space-x-2 rounded-lg border border-white/10 bg-white/5 p-2 text-sm transition-all duration-300 hover:border-sky-400/25 hover:bg-sky-400/10"
      >
        <div className="text-sky-300 transition-colors group-hover:text-sky-200">
          {social.icon}
        </div>
